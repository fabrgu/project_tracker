...
--
-- Name: students students_github_key; Type: CONSTRAINT; Schema: public; Owner: engineer
--
...
--
-- Name: grades grades_student_github_fkey; Type: FK CONSTRAINT; Schema: public; Owner: engineer
--
